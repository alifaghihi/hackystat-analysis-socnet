...
public class NeoGraphDB implements GraphDBImpl
{
    ...
    private void initializeImpl() throws DatatypeConfigurationException
    {
    ...
    public void storeRelationship(XMLRelationship xmlRel) throws 
            NodeNotFoundException
    {
        graphManager.addRelationship(xmlRel);
    }

    public XMLNode getNode(String type, String name) throws 
            NodeNotFoundException
    {
    ...
    public XMLRelationship getRelationship(int relationshipID) throws 
    ...
    public List<XMLNode> getNodes(String typeOfNodes) throws 
            NodeNotFoundException
    {
    ...
    public List<XMLRelationship> getRelationships(XMLNode connectedTo,
            String direction)
            throws InvalidArgumentException, NodeNotFoundException,
            RelationshipNotFoundException
    {
    ...
    public List<XMLRelationship> getRelationships(XMLNode connectedTo,
            ...
            RelationshipNotFoundException
    {
        return graphManager.getRelationships(connectedTo, relationshipType,
                direction);
    }
