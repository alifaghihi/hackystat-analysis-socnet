    ...
    public void acceptRepresentation(Representation entity)
    {
        ...
        try
        {
            ...
            String emailBody = "Welcome to SocNet. " + "\nYou are registered with: " 
                    ...
                    "\nYour user name is:       " + registeringuser.getEmail() +
                    "\nYour password is:        " + registeringuser.getPassword() +
            ...
            if (success)
            {
                ...
                {
                    mailer.send(adminEmail, "SocNet Admin Registration", "User " 
                            + email + " registered and received password: " +
                            registeringuser.getPassword() + "\n" + "for host: " +
                            server.getServerProperties().get(HOSTNAME_KEY));
                }

                String responseHtml = "<html>" + "  <body>" + "    Thank you for registering with SocNet. " + "    <p>" + "    Your password has been sent to: " + email + "  </body>" + "</html>";
