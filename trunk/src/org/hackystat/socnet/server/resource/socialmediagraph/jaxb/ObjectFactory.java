...
public class ObjectFactory {
  ...
  private final static QName _Value_QNAME = new QName(
      "http://hackystat-analysis-telemetry.googlecode.com/svn/trunk/xml/schema/telemetry.resource.xsd",
      "Value");
  private final static QName _Description_QNAME = new QName(
      "http://hackystat-analysis-telemetry.googlecode.com/svn/trunk/xml/schema/telemetry.resource.xsd",
      "Description");
  private final static QName _StartTime_QNAME = new QName(
      "http://hackystat-analysis-socnet.googlecode.com/svn/trunk/xml/schema/socialmediagraph.xsd",
      "StartTime");
  ...
  private final static QName _ID_QNAME = new QName(
      "http://hackystat-analysis-socnet.googlecode.com/svn/trunk/xml/schema/socialmediagraph.xsd",
      "ID");
  private final static QName _SourceCode_QNAME = new QName(
      "http://hackystat-analysis-telemetry.googlecode.com/svn/trunk/xml/schema/telemetry.resource.xsd",
      "SourceCode");
  private final static QName _Name_QNAME = new QName(
      "http://hackystat-analysis-socnet.googlecode.com/svn/trunk/xml/schema/socialmediagraph.xsd",
      "Name");
  private final static QName _Type_QNAME = new QName(
      "http://hackystat-analysis-socnet.googlecode.com/svn/trunk/xml/schema/socialmediagraph.xsd",
      "Type");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes
   * for package: org.hackystat.socnet.server.resource.socialmediagraph.jaxb
   * 
   */
  ...
  public JAXBElement<XMLGregorianCalendar> createStartTime(XMLGregorianCalendar value) {
    return new JAXBElement<XMLGregorianCalendar>(_StartTime_QNAME, XMLGregorianCalendar.class,
        null, value);
  }
  ...
  public JAXBElement<XMLGregorianCalendar> createEndTime(XMLGregorianCalendar value) {
    return new JAXBElement<XMLGregorianCalendar>(_EndTime_QNAME, XMLGregorianCalendar.class, null,
        value);
  }
