...
@XmlType(name = "", propOrder = { "telemetryChartRef" })
@XmlRootElement(name = "TelemetryChartIndex")
public class TelemetryChartIndex implements Serializable {
   ...
   * there is not a <CODE>set</CODE> method for the telemetryChartRef property.
   * 
   * <p>
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link TelemetryChartRef }
   * 
   * 
   */
