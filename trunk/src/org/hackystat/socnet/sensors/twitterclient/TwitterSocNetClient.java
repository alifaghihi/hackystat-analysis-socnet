...
public class TwitterSocNetClient
{
    ...
    public TwitterSocNetClient(String host, String clientEmail, 
    ...
    public void addNode(String nodeName, IsARelationshipType nodeType) throws 
    ...
    public void addRelationshipTo(String startNodeName,
            ...
            RelationshipType relationshipBetweenNodes) throws JAXBException,
    ...
    public ArrayList<String> getNodes(IsARelationshipType nodeType) throws 
    ...
    public boolean endRelationship(String startNodeName,
            IsARelationshipType startNodeType,
            String endNodeName, IsARelationshipType endNodeType,
    ...
    public ArrayList<String> getNodes(String nodeName,
            IsARelationshipType nodeType,
