...
public class NodeFactory {
  ...
  public enum ReferenceNodeRelationshipType implements RelationshipType {
    BOOKS, CITIES, CONCENTRATIONS, COUNTRIES, EMPLOYERS, FACEBOOK_ACCOUNTS, GROUPS, HACKYSTAT_ACCOUNTS, INTERESTS, MOVIES, MUSIC, NETWORKS, NONUSERS, POLITICAL_PARTIES, PROGRAMMING_LANGUAGES, PROJECTS, RELIGIONS, SCHOOLS, SHOWS, STATES, TWITTER_ACCOUNTS, UNIVERSITIES, USER;
  ...
  public enum IsARelationshipType implements RelationshipType {
    ...
    IS_BOOK, IS_CITY, IS_CONCENTRATION, IS_COUNTRY, IS_EMPLOYER, IS_FACEBOOK_ACCOUNT, IS_GROUP, IS_HACKYSTAT_ACCOUNT, IS_INTEREST, IS_MOVIE, IS_MUSIC, IS_NETWORK, IS_POLITICAL_PARTY, IS_PROGRAMMING_LANGUAGE, IS_PROJECT, IS_RELIGION, IS_SCHOOL, IS_SHOW, IS_STATE, IS_TWITTER_ACCOUNT, IS_UNIVERSITY, IS_USER;
  ...
  public NodeFactory(NeoService neo) {
    ...
    for (ReferenceNodeRelationshipType relationship : ReferenceNodeRelationshipType.values()) {
      ...
      if (rel == null) {
        ...
        subreferenceNodes.get(relationshipIndex).setProperty(KEY_SUBREFERENCE_NAME,
            relationship.name());
  ...
  public SocialMediaNode createNode(IsARelationshipType whatKindOfNode) {
    ...
    newNode.createRelationshipTo(subreferenceNodes.get(whatKindOfNode.ordinal()), whatKindOfNode);
  ...
  public Iterable<Node> getNodes(IsARelationshipType whatKindOfNode) {
    ...
    Iterable<Relationship> isARels = subreferenceNodes.get(whatKindOfNode.ordinal())
        .getRelationships(whatKindOfNode);
  ...
  public Iterable<Node> getNodes(String connectedToNodeName,
      IsARelationshipType connectedToNodeType, BetweenNodesRelationshipType relationshipType,
      Direction relationshipDirection) throws NodeNotFoundException, RelationshipNotFoundException {
  ...
  public SocialMediaNode getNode(SocialMediaNode startNode, RelationshipType relationship,
      Direction d, String nextNodeName) {
    Traverser traverser = startNode.getUnderNode().traverse(Order.BREADTH_FIRST,
        StopEvaluator.DEPTH_ONE, ReturnableEvaluator.ALL, relationship, d);
   ...
   * @return
   */
  public Relationship relateNodes(IsARelationshipType node1Type, String node1Key, String node1Name,
  ...
  public Relationship getRelationship(RelationshipType relationship, IsARelationshipType node1Type,
      String node1Key, String node1Name, IsARelationshipType node2Type, String node2Key,
