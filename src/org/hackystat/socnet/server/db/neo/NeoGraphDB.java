...
public class NeoGraphDB implements GraphDBImpl {
  ...
  public List<XMLRelationship> getRelationships(XMLNode connectedTo, String direction)
      throws InvalidArgumentException, NodeNotFoundException, RelationshipNotFoundException {
  ...
  public List<XMLRelationship> getRelationships(XMLNode connectedTo, String relationshipType,
      String direction) throws InvalidArgumentException, NodeNotFoundException,
