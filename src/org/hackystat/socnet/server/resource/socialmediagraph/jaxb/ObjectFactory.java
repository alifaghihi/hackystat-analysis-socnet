...
public class ObjectFactory {
    ...
    private final static QName _StartNode_QNAME = new QName("", "StartNode");
    private final static QName _Nodes_QNAME = new QName("", "nodes");
    private final static QName _EndNode_QNAME = new QName("", "EndNode");
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link XMLNode }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "", name = "StartNode")
    public JAXBElement<XMLNode> createStartNode(XMLNode value) {
        return new JAXBElement<XMLNode>(_StartNode_QNAME, XMLNode.class, null, value);
    }
    ...
    public JAXBElement<XMLNode> createNodes(XMLNode value) {
        return new JAXBElement<XMLNode>(_Nodes_QNAME, XMLNode.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "EndNode")
    public JAXBElement<XMLNode> createEndNode(XMLNode value) {
        return new JAXBElement<XMLNode>(_EndNode_QNAME, XMLNode.class, null, value);
    }
