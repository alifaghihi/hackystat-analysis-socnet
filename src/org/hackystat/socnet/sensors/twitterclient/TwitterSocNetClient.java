...
public class TwitterSocNetClient  {
    ...
    public void addNode(String nodeName, IsARelationshipType nodeType) throws JAXBException, ParserConfigurationException, TransformerConfigurationException, TransformerException
    {
        client.addNode(nodeName, nodeType.name());
        System.out.println("Store node " + nodeType.name() + ":" 
                    + nodeName + " at socnet server was successful!");
    }
    ...
    public void addRelationshipTo(String startNodeName, 
            ...
            RelationshipType relationshipBetweenNodes) throws JAXBException, ParserConfigurationException, TransformerConfigurationException, TransformerException
    {
        client.addRelationshipTo(startNodeName, startNodeType.name(), 
                                 endNodeName, endNodeType.name(), 
    ...
    public ArrayList<String> getNodes(IsARelationshipType nodeType) throws IOException, JAXBException
    {
        ...
        {
            System.out.println("Got node " + node.getType() + ":" 
                    + node.getName() + " from socnet server!");
    ...
    public ArrayList<Integer> getRelationships(String nodeName, 
    ...
    {        
        XMLRelationships rels = client.getNodes(nodeName, nodeType.name(), 
