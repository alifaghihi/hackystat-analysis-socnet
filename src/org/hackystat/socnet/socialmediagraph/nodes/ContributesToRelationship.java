...
public class ContributesToRelationship extends SocialMediaRelationship{
    ...
    public final String[] TIMESTAMP_KEYS = {BUILD_TIMESTAMPS_KEY, 
    CHURN_TIMESTAMPS_KEY,  CODE_ISSUE_TIMESTAMPS_KEY, COMMIT_TIMESTAMPS_KEY, 
    COVERAGE_TIMESTAMPS_KEY, CYCLOMATIC_COMPLEXITY_TIMESTAMPS_KEY, 
    DEV_TIME_TIMESTAMPS_KEY, ISSUE_TIMESTAMPS_KEY, UNIT_TEST_TIMESTAMPS_KEY};
    
    public final String[] VALUE_KEYS = { BUILD_VALUES_KEY, CHURN_VALUES_KEY, 
    CODE_ISSUE_VALUES_KEY, COMMIT_VALUES_KEY, COVERAGE_VALUES_KEY, 
    CYCLOMATIC_COMPLEXITY_VALUES_KEY, DEV_TIME_VALUES_KEY, ISSUE_VALUES_KEY, 
    UNIT_TEST_VALUES_KEY};
    ...
    public void updateStreams(List<TelemetryStream> streams)
    {
        ...
        for(int i = 0; i<streams.size(); i++)
        {
            ...
            this.setStream(TIMESTAMP_KEYS[i], tds.getTimestampsArray(),
                    VALUE_KEYS[i], tds.getValuesArray());
        }
    }
    
    public enum Streams{BUILD, CHURN, CODE_ISSUE, COMMIT, COVERAGE, 
    CYCLOMATIC_COMPLEXITY, DEV_TIME, ISSUE, UNIT_TEST}
    ...
    public ContributesToRelationship(Relationship underRel, List<TelemetryStream>
            streams)
    {
        super(underRel);
    ...
    public void setStream(String timestampKey, long[] timestamps, String valKey,
            double[] values)
    {
    ...
    public TelemetryDataStream getBuildStream() throws InvalidArgumentException
    {
        return new TelemetryDataStream(
                (long[]) underRelationship.getProperty(BUILD_TIMESTAMPS_KEY),
    ...
    {
        return new TelemetryDataStream(
                (long[]) underRelationship.getProperty(CHURN_TIMESTAMPS_KEY),
    ...
    {
        return new TelemetryDataStream(
                (long[]) underRelationship.getProperty(COMMIT_TIMESTAMPS_KEY),
    ...
    {
        return new TelemetryDataStream(
                (long[]) underRelationship.getProperty(COVERAGE_TIMESTAMPS_KEY),
    ...
    {
        return new TelemetryDataStream(
                (long[]) underRelationship.getProperty(CODE_ISSUE_TIMESTAMPS_KEY),
                (double[]) underRelationship.getProperty(CODE_ISSUE_VALUES_KEY));
    }
    public TelemetryDataStream getCyclomaticComplexityStream() throws InvalidArgumentException
    {
        return new TelemetryDataStream(
                (long[]) underRelationship.getProperty(CYCLOMATIC_COMPLEXITY_TIMESTAMPS_KEY),
                (double[]) underRelationship.getProperty(CYCLOMATIC_COMPLEXITY_VALUES_KEY));
    }
    public TelemetryDataStream getDevTimeStream() throws InvalidArgumentException
    {
        return new TelemetryDataStream(
                (long[]) underRelationship.getProperty(DEV_TIME_TIMESTAMPS_KEY),
    ...
    {
        return new TelemetryDataStream(
                (long[]) underRelationship.getProperty(ISSUE_TIMESTAMPS_KEY),
