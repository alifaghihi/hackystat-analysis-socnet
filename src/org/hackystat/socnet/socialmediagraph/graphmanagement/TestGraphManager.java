...
public class TestGraphManager {
  ...
  @Test
  public void testGraphAddAndRetrieveNode() throws DatatypeConfigurationException,
      NodeNotFoundException {
    assertTrue("Testing putting a node in and retrieving from the graph",
        isSuccessfulAddAndRetrieveNode());
  }

  public static boolean isSuccessfulAddAndRetrieveNode() throws DatatypeConfigurationException,
      NodeNotFoundException {
  ...
  @Test
  public void testGraphAddAndRetrieveRelationship() throws DatatypeConfigurationException,
  ...
  public static boolean isSuccessfulAddAndRetrieveRelationship()
      throws DatatypeConfigurationException, NodeNotFoundException, RelationshipNotFoundException {
    boolean wasSuccessful = false;
  ...
  @Test
  public void testGraphRetrieveAllNodes() throws DatatypeConfigurationException,
      NodeNotFoundException {
    assertTrue("testGraphRetrieveAllNodes", isSuccessfulRetrieveAllNodes());
  }

  public static boolean isSuccessfulRetrieveAllNodes() throws DatatypeConfigurationException,
      NodeNotFoundException {
    boolean wasSuccessful = false;
  ...
  @Test
  public void testGraphRetrieveNodesOfSpecifiedType() throws DatatypeConfigurationException,
      NodeNotFoundException {
    assertTrue("testGraphRetrieveAllNodes", isSuccessfulRetrieveAllNodes());
  }
