...
public class RelationshipNotFoundException extends Exception {
  ...
  public RelationshipNotFoundException(String relationshiptype, String startNodeName,
    ...
    super("\nThe relationship of type " + relationshiptype + " starting at the " + "node of type "
        + startNodeType + " named " + startNodeName + " and " + "ending at the node of type "
        + endNodeType + " named " + endNodeName + " does not exist in the graph\n");

  }

  public RelationshipNotFoundException(String nodeName, String nodeType) {
    super("\nNo relationships connected to the node of type " + nodeType + " named " + nodeName
        + " exist in the graph.\n");
  }

  public RelationshipNotFoundException(String nodename, String nodetype,
      String relationshipdirection) {
    super("\nNo " + relationshipdirection + " relationships connected to the " + "node of type "
        + nodetype + " named " + nodename + " exist in the graph.\n");
  }

  public RelationshipNotFoundException(String nodename, String nodetype,
      String relationshipdirection, String relationshipType) {
    super("\nNo " + relationshipdirection + " relationships of type " + relationshipType
        + " connected to the node of type " + nodetype + " named " + nodename
        + " exist in the graph.\n");
  }
}
